...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'buy':
        keyboard = [
            [InlineKeyboardButton("1 Acc (₹20)", callback_data='amt_1')],
        ...
        await query.message.reply_photo(photo=bio, caption=f"💰 Amount to Pay: ₹{total}\nScan this QR. Once paid, click the button below to submit your UTR.", reply_markup=InlineKeyboardMarkup(btn))
...
if __name__ == '__main__':
    ...
    app.add_handler(CallbackQueryHandler(button_handler, pattern='^(buy|amt_.*)$'))
